...
$GLOBALS['procesos']=$conexion->consultaProceso('2');
$GLOBALS['proccomentario']=$conexion->consultarComentarios('CursoEspecial');
...
<header>
    ...
    <section class="SecContenido">
        ...
        <main class="mainE">
            <div>
                <h5>Descripcion del proceso para solicitar un curso especial</h5>
            </div>
            ...
            <div>
                <form action="datosComentarios.php">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="hidden" id="proc" name="proc" value="CursoEspecial">
