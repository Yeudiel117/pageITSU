...
$GLOBALS['procesos']=$conexion->consultaProceso('1');
$GLOBALS['proccomentario']=$conexion->consultarComentarios('Inscripcion');
...
<header>
    ...
    <section class="SecContenido">
        ...
        <main class="mainE">
            <div>
                <h5>Descripcion del proceso para inscribirse y reinscribirse</h5>
            </div>
            ...
            <div>
                <form action="datosComentarios.php">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="hidden" id="proc" name="proc" value="Inscripcion">
