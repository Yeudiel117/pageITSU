...
$GLOBALS['procesos']=$conexion->consultaProceso('6');
$GLOBALS['proccomentario']=$conexion->consultarComentarios('BajaTemp');
...
<header>
    ...
    <section class="SecContenido">
        ...
        <main class="mainE">
            <div>
                <h5>Descripcion del proceso para darse de baja Temporal</h5>
            </div>
            ...
            <div>
                <form action="datosComentarios.php">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="hidden" id="proc" name="proc" value="BajaTemp">
