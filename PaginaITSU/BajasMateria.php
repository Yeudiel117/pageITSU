...
$GLOBALS['procesos']=$conexion->consultaProceso('4');
$GLOBALS['proccomentario']=$conexion->consultarComentarios('BajasMateria');
...
<header>
    ...
    <section class="SecContenido">
        ...
        <main class="mainE">
            <div>
                <h5>Descripcion del proceso para dar de baja una materia</h5>
            </div>
            ...
            <div>
                <form action="datosComentarios.php">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="hidden" id="proc" name="proc" value="BajasMateria">
