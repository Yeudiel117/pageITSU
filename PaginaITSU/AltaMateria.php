...
$GLOBALS['procesos']=$conexion->consultaProceso('3');
$GLOBALS['proccomentario']=$conexion->consultarComentarios('AltaMateria');
...
<header>
    ...
    <section class="SecContenido">
        ...
        <main class="mainE">
            <div>
                <h5>Descripcion del proceso para dar de alta materias</h5>
            </div>
            ...
            <div>
                <form action="datosComentarios.php">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="hidden" id="proc" name="proc" value="AltaMateria">
