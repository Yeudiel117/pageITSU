...
$GLOBALS['procesos']=$conexion->consultaProceso('5');
$GLOBALS['proccomentario']=$conexion->consultarComentarios('Kardex');
?>
...
<header>
    ...
    <section class="SecContenido">
        ...
        <main class="mainE">
            <div>
                <h5>Descripcion del proceso para solicitar un historial academico</h5>
            </div>
            ...
            <div>
                <form action="datosComentarios.php">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="hidden" id="proc" name="proc" value="Kardex">
